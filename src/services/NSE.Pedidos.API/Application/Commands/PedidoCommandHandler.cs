...
using NSE.Pedidos.Dominio.Vouchers.Specs;
...
namespace NSE.Pedidos.API.Application.Commands
{
        ...
        IRequestHandler<AdicionarPedidoCommand, ValidationResult>
    {
        ...
        public async Task<ValidationResult> Handle(AdicionarPedidoCommand message, 
        ...
        private Pedido MapearPedido(AdicionarPedidoCommand message)
        {
            var endereco = new Endereco
            {
                ...
                Complemento = message.Endereco.Bairro,
        ...
        {
            if (!message.VoucherUtilazado) return true;
        ...
        private bool ValidarPedido(Pedido pedido)
        {
            ...
            {
                AdicionarErro("O valor total não confere como o cálculo do pedido");
                return false;
            }
